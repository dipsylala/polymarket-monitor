...
TRUE POSITIVES (should fire alerts):
  - Iran strike incident profile  (Feb 2026): new wallet, funded <48h, low odds, large bet
  - Venezuela/Maduro incident profile (Jan 2026): new wallet, funded <48h, low odds, large bet
  - ZachXBT/Axiom profile (Feb 2026): same wallet signals, low-odds bet on investigation market
...
TRUE NEGATIVES (should NOT fire alerts):
  ...
  - Small bet below MIN_BET_USDC → never enters scoring pipeline
  - New wallet, large bet, but at high odds → suppressed
"""
...
import config
import detector
from detector import ScoreResult, score_wallet
